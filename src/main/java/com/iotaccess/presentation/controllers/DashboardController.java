...
import com.iotaccess.application.schedulers.BatchProcessingJob;
...
public class DashboardController {
    ...
    public String dashboard(Model model) {
        ...
        DayStatsDto stats = accessService.getDayStats();
    ...
    @ResponseBody
    public ResponseEntity<DayStatsDto> getDayStats() {
