...
import com.iotaccess.application.services.IdentityService;
...
/**
 * Implementación del servicio de gestión de dispositivos y enrolamiento.
...
public class DeviceManagementServiceImpl implements DeviceManagementService {
    ...
    public DeviceManagementServiceImpl(IdentityService identityService,
    ...
    public boolean validateAdminUid(String uid) {
        ...
        log.info("Validando UID del admin. Recibido: [{}] -> [{}], Esperado: [{}] -> [{}]",
                uid, strippedUid, adminUid, strippedAdmin);

        if (strippedUid.equals(strippedAdmin)) {
    ...
    public void captureUidForEnrollment(String uid) {
        ...
        if (stripUidSeparators(uid).equals(stripUidSeparators(adminUid))) {
